    ...
    return (
      <div className="bg-gray-50">
        ...
        <motion.div
          ...
          animate="visible"
          variants={fadeIn}
          className="flex flex-col items-center px-6 py-12 lg:flex-row lg:justify-between lg:px-16 lg:py-20"
        >
          {/* Left Content */}
          <div className="space-y-6 text-center lg:text-left">
            <h1 className="text-3xl font-extrabold leading-snug text-gray-900 sm:text-4xl lg:text-5xl">
              Fasta AI CV Builder
            </h1>
            <p className="my-2 text-2xl font-semibold">
              Your AI-Powered CV Builder
            </p>
            <p className="mt-4 text-base text-gray-600 md:w-3/4 md:text-lg">
              Craft a professional and tailored CV effortlessly with our
              AI-powered builder. Showcase your skills and achievements to stand
              out in today’s competitive job market.
            </p>
            <Link
              href={"/select-template"}
              className="inline-block rounded-lg bg-yellow-500 px-6 py-3 text-sm font-semibold text-black shadow-md hover:bg-yellow-600 hover:shadow-lg"
            >
          ...
          >
            <Image
              ...
              width={400}
              height={300}
              className="rounded-lg shadow-md lg:rotate-6"
            />
          </motion.div>
        </motion.div>
        ...
        variants={fadeIn}
        id="home"
        className="flex flex-col items-center px-8 py-16 md:h-screen lg:flex-row lg:items-start"
      >
                ...
                <div className="mt-6 space-y-6 text-left">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Select from a range of modern, professional templates
                        that suit your industry and style.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 text-left">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Add your personal details, experience, education,
                        skills, and professional summary. Let our AI optimize
                  ...
                  <div className="flex items-start space-x-4 text-left">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Review your CV and download it in a format of your
                        choice, ready to impress employers.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <footer className="bg-gray-900 px-8 py-16">
          <div className="mx-auto grid max-w-screen-lg grid-cols-1 gap-8 lg:grid-cols-2">
            <div className="space-y-4">
              <h3 className="mb-4 text-center text-3xl font-bold text-yellow-500">
                Contact Us
              </h3>
              <p className="mt-4 text-gray-300">
                Have questions? Feel free to contact us. We’re here to assist
                you!
              </p>
              <p className="font-semibold text-white">Call us: 0735-338-149</p>
              <p className="font-semibold text-white">
                Email: support@fastaai.store
              </p>
            </div>
